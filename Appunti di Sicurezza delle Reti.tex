...
\end{example}
Adesso definiamo il campo di Galois $p^{n}$ nel modo seguente:\marginpar{\rule[0.5ex]{3cm}{1pt}\textbf{\footnotesize{}}\protect \\
\textbf{\footnotesize{}Campo di Galois}{\footnotesize{}\index{Galois, campo di@{\footnotesize{}Galois, campo di}}}}[0.3cm]
\begin{equation}
...
$\mathbb{Z}_{p}$ & $\mathcal{GF}\left(p^{n}\right)$\tabularnewline
\hline 
